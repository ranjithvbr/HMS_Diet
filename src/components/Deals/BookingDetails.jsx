...
export default class BookingDetails extends React.Component {
    ...
    changeTabFun = (data) => {
        ...
        // this.state.serviceTypeAll = data.deal_service_type === " " ? false : true;
        // this.state.bookingDetails.service_type.value = data.deal_service_type;
    ...
    getServiceType = () => {
        Axios({
            method: "POST",
            url: apiurl + "Diet/getdealsdietpackage",
            data: {
                "dietvendorId":"12"
            },
          })
            .then((response) => {
                console.log(response,"response_checking_test")
              console.log(
                response.data.data.map((val) => {
                  return { id:val.dietpackageId, serviceType: val.diet_package_name };
                }),
                "sadfasdf"
              );
              this.setState(
                ...
                //   console.log(val.diet_package_name,"test_chk")
                },
