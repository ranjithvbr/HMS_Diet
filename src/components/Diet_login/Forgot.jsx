...
import Diet from '../../Images/Diet_background.png'
import './Forgot.css'
       ...
       return (
              ...
              <Grid item xs={12} md={7} className="pharmacy_image_grid">
                    ...
                    <div className="pharmacy_image_login">
                       <img src={Diet} alt="1" className="pharmacy_image"/>
                         <p className="pharmacy_text">DIET</p>
                    </div>
                  </div>
                  </div>
                    </Grid>
      ...
      <InputAdornment>
        ...
        <img className="inbox_icon" src={Inbox}/>
                 ...
                 <div className="pharmacy_submit_container">
                   <a href="">
                     <button className="login" component={Link} 
                      onClick={this.resetPassword}>Submit</button>
                    </a>
                 </div>

                 <div className="cancel_container">
                   <a component={NavLink} href="/" className="cancelbutton">Cancel</a>
                 </div>
                </div>
                       </div>
                       </div>
