    ...
    return (
      ...
      <div>
        ...
        <Modalcomp
          ...
          xswidth={"xs"}
        >
          <ViewMedia visible={this.state.openview} viewData={this.state.viewData} clrchange="text_clr_change" viewopenModal ={this.state.openview && true}/>
        </Modalcomp>

        <Modalcomp  visible={this.state.editopen} editData={this.state.editData}  title={"EDIT MEDIA UPLOADS"} closemodal={(e) => this.closemodal(e)} clrchange="text_clrchange">
        ...
        <Modalcomp  visible={this.state.deleteopen} title={"Delete Media"} closemodal={this.closemodal} xswidth={"xs"} clrchange="text_clrchange" >
